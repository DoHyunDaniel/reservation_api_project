...
public class UpdateUser {
	...
	public static class Response {
		...
		public static Response from(UserDto userDto) {
			return Response.builder().id(userDto.getId()).userId(userDto.getUserId()).nickname(userDto.getNickname())
					.userType(userDto.getUserType()).email(userDto.getEmail()).createdAt(userDto.getCreatedAt()).phoneNumber(userDto.getPhoneNumber())
					.build();
		}
